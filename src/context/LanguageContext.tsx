...
export const translations = {
  tr: {
    ...
    home_about_desc: "Bandırma merkezli Kenet Mimarlık; Göktuğkan Şirin ve Hüseyin Akar tarafından kurulan, ruhsat, tasarım ve uygulama süreçlerini bütüncül ele alan genç ve yenilikçi bir mimarlık stüdyosudur.",
    home_stat1_n: "2",
    home_stat1_l: "kurucu",
    home_stat2_n: "Tek",
    home_stat2_l: "ekip",
    ...
    studio_desc: "Bandırma merkezli; ruhsat projesi, bütüncül mimari tasarım, iç mekân kurgusu ve uygulama pratiği.",
    ...
    services_desc: "Bandırma ve çevresinde fikirden ruhsata, detay projeden şantiye teslimine kadar tüm süreçte yanınızdayız.",
  ...
  en: {
    ...
    home_about_desc: "Based in Bandırma, Kenet Mimarlık was founded by Göktuğkan Şirin and Hüseyin Akar to deliver a young, dynamic, and holistic approach to permit, design, and build processes.",
    home_stat1_n: "2",
    ...
    studio_title: "Kenet Mimarlık",
    studio_desc: "A Bandırma-based practice delivering permit projects, holistic architectural design, interior spatial concepts, and turn-key execution.",
    ...
    services_desc: "Serving Bandırma and the surrounding region from initial concepts and permits to working drawings and turn-key site delivery.",
...
const routeMap: Record<string, { tr: string; en: string }> = {
  ...
  "/en/about": { tr: "/hakkimizda", en: "/en/about" },
